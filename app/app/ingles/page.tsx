    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center gap-3 mb-2">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[oklch(0.75_0.15_45)]">
            <Globe className="h-6 w-6 text-white" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-foreground">Ingles</h1>
            <p className="text-muted-foreground">Learn English with fun activities!</p>
          </div>
        </div>
      </div>
          ...
          {(!activities || activities.length === 0) && (
            <div className="rounded-lg border-2 border-dashed p-12 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Novas atividades de ingles em breve!
              </p>
            </div>
          )}
        </TabsContent>
