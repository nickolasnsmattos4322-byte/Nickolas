...
import { Palette, Loader2, Check, Eye, EyeOff, Sparkles, Star, Play } from 'lucide-react'
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#FFF9F0] px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-16 h-16 bg-[#FFD93D] rounded-full opacity-20 animate-bounce" style={{ animationDelay: '1.5s', animationDuration: '4.5s' }}/>
      ...
      <Card className="w-full max-w-md border-4 border-[#E8F8EA] shadow-2xl bg-white rounded-3xl relative z-10">
        <CardHeader className="text-center pb-2">
          <Link href="/" className="mx-auto mb-4 flex items-center gap-3 group">
            <div className="relative">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#6BCB77] to-[#1DD1A1] shadow-lg group-hover:scale-110 transition-transform">
        ...
        <CardContent className="pt-4">
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <span className="w-full border-t-2 border-[#E8F8EA]" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 rounded-xl border-2 border-[#E8F8EA] focus:border-[#6BCB77] text-base"
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  minLength={6}
                  disabled={loading || loadingGoogle}
                  className="h-12 rounded-xl border-2 border-[#E8F8EA] focus:border-[#6BCB77] text-base pr-12"
                />
                <Button
                  type="button"
                  variant="ghost"
                  size="icon"
                  className="absolute right-2 top-1/2 -translate-y-1/2 hover:bg-[#E8F8EA] rounded-lg"
            ...
            <div className="rounded-2xl bg-gradient-to-r from-[#E8F8EA]/50 to-[#FFF8E1]/50 p-4 border-2 border-[#E8F8EA]">
            ...
            <Button 
              type="submit" 
              className="w-full h-14 text-lg font-bold rounded-xl bg-gradient-to-r from-[#6BCB77] to-[#1DD1A1] hover:opacity-90 shadow-lg shadow-[#6BCB77]/30" 
              disabled={loading || loadingGoogle}
            >
              {loading ? (
                <>
